...
# DOUBAO appid + appkey
# CM appId  = 300012508715
# CM appKey = 0ABC36EBE17445692CC54999BBB6B4EC
# com.larus.nova
# F32D2DAAE92240FFEB6660F5F3325009

# 参与 sign 计算但不进入 plaintext 的隐藏字段。
# 来源: cmcc.properties -> BuildConfig.CMCC_APP_KEY。改这个值也必须重算 sign。
APP_KEY = "0ABC36EBE17445692CC54999BBB6B4EC"
...
PLAINTEXT_FIELDS = {
    ...
    "appSign":      "F32D2DAAE92240FFEB6660F5F3325009",
    "boundid":      "",
    "ipv4List":     "10.146.13.39",
    "ipv6List":     "2409:892a:e4c:c37b:18d1:26f5:182a:1fe8",
    "sdkType":      "002",
    "tempPdr":      "%645ae41398464d4b810c94c2ad898538",
    "scrip":        "",
    "userCapaid":   "200",
    "funcType":     "authz",
    "socketIp":     "2409:892a:e4c:c37b:18d1:26f5:182a:1fe8",
}
...
def main() -> int:
    ...
    if args.ipv6:
        fields["ipv6List"] = args.ipv6
        fields["socketIp"] = args.ipv6
    fields["sign"] = compute_sign(fields, APP_KEY)
    ...
    if args.ipv6:
        ...
        if html_path.exists():
            ...
            new_literal = json.dumps(body_raw, ensure_ascii=False)
